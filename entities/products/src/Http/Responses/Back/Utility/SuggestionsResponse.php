...
namespace InetStudio\ChecksContest\Products\Http\Responses\Back\Utility;
...
class SuggestionsResponse implements SuggestionsResponseContract
{
    ...
    public function toResponse($request)
    {
        $transformer = app()->make(
            'InetStudio\ChecksContest\Products\Contracts\Transformers\Back\Utility\SuggestionTransformerContract',
            [
                'type' => $this->type,
            ]
        );
