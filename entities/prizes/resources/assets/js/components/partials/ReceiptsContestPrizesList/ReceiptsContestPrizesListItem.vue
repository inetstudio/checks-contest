...
<script>
  export default {
    name: 'ReceiptsContestPrizesListItem',
    props: {
      prize: {
        type: Object,
        required: true
    ...
    methods: {
      edit() {
        ...
        window.Admin.vue.stores['receipts_contest_prizes'].commit('setMode', 'edit_list_item');
        window.Admin.vue.stores['receipts_contest_prizes'].commit('setPrize', component.prize);
