{!! Form::open(['url' => route('back.checks-contest.checks.update', [$item['id']]), 'id' => 'mainForm', 'enctype' => 'multipart/form-data']) !!}
    @if ($item['id'])
        {{ method_field('PUT') }}
    @endif
        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    ...
                    <div class="m-b-lg">
                        @include('admin.module.checks-contest.checks::back.modals.additional_fields')
                    </div>
                </div>
            </div>
        </div>
