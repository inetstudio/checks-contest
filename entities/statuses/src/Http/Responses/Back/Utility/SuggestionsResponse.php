...
namespace InetStudio\ChecksContest\Statuses\Http\Responses\Back\Utility;
...
class SuggestionsResponse implements SuggestionsResponseContract
{
    ...
    public function toResponse($request)
    {
        $transformer = app()->make(
            'InetStudio\ChecksContest\Statuses\Contracts\Transformers\Back\Utility\SuggestionTransformerContract',
            [
                'type' => $this->type,
            ]
        );
