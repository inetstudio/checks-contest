        ...
        if (typeof reason !== typeof undefined && reason !== false) {
          Swal.fire({
            ...
            inputOptions: {
              ...
              'Сумма покупки не соответствует условиям акции': 'Сумма покупки не соответствует условиям акции',
              'Превышен лимит регистрации чеков': 'Превышен лимит регистрации чеков',
              'Дубликат': 'Дубликат',
